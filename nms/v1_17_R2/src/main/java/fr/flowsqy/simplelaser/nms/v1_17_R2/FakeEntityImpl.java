...
public abstract class FakeEntityImpl implements FakeEntity {
    ...
    static {
        try {
            ...
            packedItemField = ClientboundSetEntityDataPacket.class.getDeclaredField(ObfuscateFieldNames.PACKED_ITEMS);
    ...
    public void create(Vector position) {
        ...
        final List<SynchedEntityData.DataItem<?>> packedItems = injectList(dataPacket);
        // Default flags
    ...
    protected ClientboundSetEntityDataPacket createDataPacket() {
        return new ClientboundSetEntityDataPacket(entityId, new SynchedEntityData(null), false);
    }

    protected List<SynchedEntityData.DataItem<?>> injectList(ClientboundSetEntityDataPacket dataPacket) {
    ...
    public void teleport(Vector position) {
        ...
        final ClientboundTeleportEntityPacket teleportEntityPacket = new ClientboundTeleportEntityPacket(buffer);
