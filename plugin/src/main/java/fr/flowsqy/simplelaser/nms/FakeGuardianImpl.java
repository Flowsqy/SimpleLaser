...
public class FakeGuardianImpl extends FakeEntityImpl implements FakeGuardian {
    ...
    static {
        try {
            final Field dataIdAttackTargetField = Guardian.class
                    .getDeclaredField(ObfuscateFieldNames.DATA_ID_ATTACK_TARGET);
    ...
    public void target(FakeSquid squid) {
        ...
        injectList(dataPacket).add(SynchedEntityData.DataValue.create(DATA_ID_ATTACK_TARGET, squid.getId()));
